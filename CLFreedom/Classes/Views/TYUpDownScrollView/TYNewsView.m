...
- (void)_setup {
    ...
    _imageView.image = [UIImage imageNamed:@"business"];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-45-[_imageView(==HW)]-10-[_contentView]-0-|" options:0 metrics:metrics views:views]];
    ...
    self.lineImageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 5, 1, 25)];
    self.lineImageView.image = [UIImage imageNamed:@"line_shu"];
    self.lineImageView.alpha = 0.5;
    [_contentView addSubview:self.lineImageView];
}
